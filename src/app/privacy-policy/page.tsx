...
const policy = {
  ...
  sections: [
    ...
    {
      title: "10. Contato",
      content: "Em caso de dúvidas sobre esta Política de Privacidade ou sobre o tratamento de seus dados, entre em contato pelo e-mail: suporte@olhononivel.com.br ou WhatsApp: (11) 99999-9999."
    }
  ]
};
