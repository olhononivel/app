...
const terms = {
	...
	sections: [
		...
		{
			title: "15. Contato",
			content: "Para dúvidas sobre estes Termos e Condições, entre em contato conosco através do email: suporte@olhononivel.com.br ou pelo WhatsApp: (11) 99999-9999. Nossa equipe de suporte está disponível para esclarecer qualquer questão sobre o uso do sistema."
		}
	]
};
