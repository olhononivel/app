...
const faqItems = [
	...
	},
	{
		...
		answer:
			"Para entrar em contato conosco, ligue para (62) 9 9808-4683 ou envie um e-mail para suporte@olhononivel.com.br. Nosso horário de atendimento é de segunda a sexta, das 8h às 18h."
	}
];
